    ...
    with st.container(border=True):
        ...
        if rs_loaded_rows:
            ...
            if export_candidate_rows:
                st.markdown("**Descargar usuarios de las clases (una, varias o todas)**")
                export_group_by_id = {
                ...
                select_all_report_classes = st.checkbox(
                    "Seleccionar todas las clases",
                    key="rs_rs_groups_report_select_all",
                )
                report_group_select_key = "rs_rs_groups_report_class_ids"
                multiselect_report_selection = list(
                    st.multiselect(
                        "Clases para descargar usuarios (una, varias o todas)",
                        ...
                        disabled=select_all_report_classes,
                    )
                    or []
                )
                selected_report_group_ids = (
                    list(export_group_options)
                    if select_all_report_classes
                    else multiselect_report_selection
                )
